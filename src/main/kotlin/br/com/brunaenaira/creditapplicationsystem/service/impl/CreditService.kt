...
import br.com.brunaenaira.creditapplicationsystem.repository.CreditRepository
import br.com.brunaenaira.creditapplicationsystem.service.ICreditService
...
class CreditService(
    ...
    override fun findByCreditCode(customerId: Long, creditCode: UUID): Credit {
        val credit: Credit = (this.creditRepository.findByCreditCode(creditCode)
            ?: throw br.com.brunaenaira.creditapplicationsystem.exception.BusinessException("Creditcode $creditCode not found"))
    ...
    private fun validDayFirstInstallment(dayFirstInstallment: LocalDate): Boolean {
        ...
        else throw br.com.brunaenaira.creditapplicationsystem.exception.BusinessException("Invalid Date")
    }
}
