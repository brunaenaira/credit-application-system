...
import br.com.brunaenaira.creditapplicationsystem.dto.request.CustomerDto
...
class CustomerResourceTest {
    ...
    fun `should create a customer and return 201 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Ariane"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("75869594093"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("brunaenaira@gmail.com"))
    ...
    fun `should find customer by id and return 200 status`() {
        //given
        val customer: br.com.brunaenaira.creditapplicationsystem.entity.Customer =
            customerRepository.save(builderCustomerDto().toEntity())
        //when
        //then
        mockMvc.perform(
    ...
    fun `should not find customer with invalid id and return 400 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$.exception")
                    .value("class me.dio.credit.application.api.exception.BusinessException")
            )
            .andExpect(MockMvcResultMatchers.jsonPath("$.details[*]").isNotEmpty)
            .andDo(MockMvcResultHandlers.print())
    }
    ...
    fun `should update a customer and return 200 status`() {
        ...
        val customer: br.com.brunaenaira.creditapplicationsystem.entity.Customer =
            customerRepository.save(builderCustomerDto().toEntity())
        val customerUpdateDto: br.com.brunaenaira.creditapplicationsystem.dto.request.CustomerUpdateDto =
    ...
    ): br.com.brunaenaira.creditapplicationsystem.dto.request.CustomerUpdateDto =
        br.com.brunaenaira.creditapplicationsystem.dto.request.CustomerUpdateDto(
            firstName = firstName,
            lastName = lastName,
            income = income,
